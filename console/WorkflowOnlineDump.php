<?php namespace Waka\Workflow\Console;
...
use Waka\Workflow\Classes\GraphvizDumper;
use Workflow;
// use Symfony\Component\Console\Input\InputArgument;
...
class WorkflowOnlineDump extends WorkflowCreate
{
    ...
    public function handle()
    {
        ...
        $importExcel = new \Waka\Workflow\Classes\Imports\ImportWorkflow($workflowName);
        ...
        $prepareExcel = new \Waka\Workflow\Classes\CreateWorkflowDataFromExcel();
        $this->vars = $prepareExcel->prepareVars($data);
        $this->workflowData = $this->makeAndGetStubs();

        $class = '\Waka\Workflow\Models\TestWf';
